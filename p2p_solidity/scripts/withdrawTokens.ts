...
const p2pContract = new ethers.Contract("0x7410eE998bf93640aAe11E7195600c63b22c0286", p2pAbi, signer);
...
// console.log("whiteListSUSDCTx:", whiteListSUSDCTx.hash);
    const withdrawTxn = await p2pContract.connect(signer2).withdrawSellOrder(1);
    await withdrawTxn.wait();
    console.log("Deposit completed: ", withdrawTxn.hash);
